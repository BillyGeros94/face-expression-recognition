...
This project uses `renv` for R package management. After cloning, open the project in RStudio (or run ```r R -e "renv::restore()" ```) to install the exact package versions recorded in `renv.lock`.  
